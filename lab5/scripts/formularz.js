...
function zmianaWartosciPola(){
    alert("Zmieniono wartość imienia!");
}

function wklejono(){
    alert("Wklejono wartość!")
}

window.addEventListener("submit", komunikat);
document.getElementById("wpisz-imie").addEventListener("change", zmianaWartosciPola);
document.getElementById("wpisz-nazw").addEventListener("paste", wklejono)
